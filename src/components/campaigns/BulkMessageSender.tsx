...
export const BulkMessageSender: React.FC = () => {
  ...
  const { list: contacts = [], loading: contactsLoading } = useSelector((state: any) => state.contacts);
  const { items: groups = [], loading: groupsLoading } = useSelector((state: any) => state.groups);
